...
export const Scene10_MockProfile: React.FC = () => {
  ...
  return (
    ...
    >
      <ParticleField />
      <GlowOrb x="50%" y="40%" size={700} color="rgba(201,168,76,0.15)" delay={0} />
      <GlowOrb x="25%" y="70%" size={400} color="rgba(232,160,160,0.12)" delay={40} />
      <GlowOrb x="80%" y="25%" size={350} color="rgba(155,142,196,0.12)" delay={20} />
      ...
      <div
        style={{
          ...
          padding: "40px",
          borderRadius: 32,
          background: "linear-gradient(145deg, rgba(201,168,76,0.08) 0%, rgba(18,18,26,0.98) 50%, rgba(155,142,196,0.05) 100%)",
      ...
      >
        ...
        >
          <div style={{ fontFamily: fonts.serif, fontSize: 32, color: colors.textPrimary, fontWeight: 600 }}>
            Amara Okafor
          </div>
          <div style={{ fontFamily: fonts.sans, fontSize: 14, color: colors.textSecondary, marginTop: 4 }}>
            28 · Brooklyn, NY · Art Curator
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 10, color: colors.lavender, letterSpacing: 1, textTransform: "uppercase", marginTop: 4 }}>RIF Align</div>
          </div>
        </div>
        ...
        >
          "I believe connection starts with curiosity. Let's skip the small talk
          and talk about what makes us feel alive."
        </div>
        ...
        >
          ...
          <RIFMiniBar label="Creative" value={0.88} color={colors.lavender} frame={frame} delay={72} />
          <RIFMiniBar label="Growth" value={0.85} color={colors.gold} frame={frame} delay={79} />
          <RIFMiniBar label="Loyalty" value={0.94} color={colors.roseLight} frame={frame} delay={86} />
        </div>
