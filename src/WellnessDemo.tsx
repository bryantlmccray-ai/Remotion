...
const SCENES = [
  ...
  { component: Scene03_LandingPage, duration: 180, label: "Landing Page" },       // 6s
  ...
  { component: Scene07_AIInsights, duration: 210, label: "AI Insights" },         // 7s
  { component: Scene08_Discovery, duration: 210, label: "Discovery" },            // 7s
  { component: Scene09_CTA, duration: 210, label: "Call to Action" },             // 7s
];
